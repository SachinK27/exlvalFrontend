    ...
    <Grid>
      ...
      >
        ...
        <Typography variant="body1" align="center">
          Let's create some magic toegther!
        </Typography>
      </Container>
...
{/* display={{ xs: "none", sm: "none", md: "block", lg: "block" }} */}
      <Container ref={parentRef} sx={{ pt: 7, maxWidth: "100vw !important", fontSize: "18px" }}>
      ...
      <Grid item sm={12} md={5} lg={5} display={{ xs: "none", sm: "none", md: "block", lg: "block" }} style={{ position: "relative" }}>
          ...
          <Grid item sm={12} md={6} lg={7}>
            ...
            <Grid container spacing={2} sx={{ my: 5,px:5,"@media (max-width: 959.95px)": {
                   px:0
                  } }}>
